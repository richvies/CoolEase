...
#if ((EEPROM_SHARED_INFO_SIZE + EEPROM_BOOT_INFO_SIZE + EEPROM_APP_INFO_SIZE + \
      EEPROM_LOG_SIZE) > EEPROM_SIZE)
...
#define EEPROM_SHARED_INFO_END                                                 \
    (EEPROM_SHARED_INFO_BASE + EEPROM_SHARED_INFO_SIZE)

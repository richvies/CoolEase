...
public:
	...
	Si4432(uint8_t sdnPin, uint8_t InterruptPin, uint8_t ssPin); // when a InterruptPin is given, interrupts are checked with this pin - rather than SPI polling
...
protected:
	...
	uint8_t _sdnPin, _intPin, _ssPin;

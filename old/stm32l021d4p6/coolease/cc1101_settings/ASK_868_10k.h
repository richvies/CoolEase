...
write_reg_single(MDMCFG4,0x88); //Modem Configuration
write_reg_single(MDMCFG3,0x84); //Modem Configuration
...
write_reg_single(AGCCTRL2,0x04);//AGC Control
write_reg_single(AGCCTRL1,0x00);//AGC Control
write_reg_single(AGCCTRL0,0x92);//AGC Control

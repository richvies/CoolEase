...
write_reg_single(FSCTRL1,0x08); //Frequency Synthesizer Control
...
write_reg_single(MDMCFG4,0x8B); //Modem Configuration
write_reg_single(MDMCFG3,0xE5); //Modem Configuration
...
write_reg_single(AGCCTRL0,0xB2);//AGC Control

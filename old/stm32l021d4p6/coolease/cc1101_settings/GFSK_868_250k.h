...
write_reg_single(FSCTRL1,0x0C); //Frequency Synthesizer Control
...
write_reg_single(MDMCFG4,0x8D); //Modem Configuration
write_reg_single(MDMCFG3,0x2F); //Modem Configuration
...
write_reg_single(FOCCFG,0x1D);  //Frequency Offset Compensation Configuration
write_reg_single(BSCFG,0x1C);   //Bit Synchronization Configuration
write_reg_single(AGCCTRL2,0xC7);//AGC Control
write_reg_single(AGCCTRL1,0x00);//AGC Control
write_reg_single(AGCCTRL0,0xB0);//AGC Control
...
write_reg_single(FREND1,0xB6);  //Front End RX Configuration
write_reg_single(FREND0,0x10);  //Front End TX Configuration
write_reg_single(FSCAL3,0xEA);  //Frequency Synthesizer Calibration

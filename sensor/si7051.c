...
void si7051_end(void) {
    ...
    // TMP112_CONFIG_OS_LSB}; i2c_transfer7(I2C1, TMP112_I2C_ADDRESS, config, 3,
    // NULL, 0);
...
static void si7051_i2c_setup(void) {
    ...
    gpio_mode_setup(TEMP_I2C_SCL_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE,
                    TEMP_I2C_SCL);
    gpio_mode_setup(TEMP_I2C_SDA_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE,
                    TEMP_I2C_SDA);
